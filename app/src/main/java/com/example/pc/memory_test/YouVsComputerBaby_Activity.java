...
public class YouVsComputerBaby_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.you_vs_computer_baby_layout);
    ...
    private void checkEnd() {
        ...
        {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(YouVsComputerBaby_Activity.this,R.style.MyAlertDialogStyle);
            if (language.equals("albanian"))
            {
                alertDialogBuilder.setTitle("Loja perfundoj");
                alertDialogBuilder.setMessage("\n"+username+" " + playerPoints + "\nENIAC: " + cpuPoints).setCancelable(false)
                        .setPositiveButton("LOJE E RE", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {

                                Intent intent = new Intent(getApplicationContext(), YouVsComputerBaby_Activity.class);
