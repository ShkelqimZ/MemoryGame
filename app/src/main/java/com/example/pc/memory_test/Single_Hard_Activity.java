...
public class Single_Hard_Activity extends AppCompatActivity {

    TextView tv_p1,tv_countdown;
    String language="";
    String username="";
    String playerPointsMedium="";
    Integer scoreHard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.single__hard_layout);
        ...
        playerPointsMedium=objIntent.getStringExtra("playerPointsMedium");
    ...
    private void dialog()
    {
        AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(Single_Hard_Activity.this,R.style.MyAlertDialogStyle);
        if (language.equals("albanian"))
        {

            if (!playerPointsMedium.isEmpty())
            {
                 scoreHard=playerPoints +Integer.parseInt(playerPointsMedium);
            }
            else {
                scoreHard=playerPoints;
            }

            alertDialogBuilder.setTitle("Loja perfundoj");
            alertDialogBuilder.setMessage("\nPIKET : " + scoreHard ).setCancelable(false)
            ...
            alertDialogBuilder.setMessage("\nPOINTS: " + scoreHard).setCancelable(false)
    ...
    private void rotation3D(final View v , final int theCard)
    {
        ...
        final AnimatorSet objAnimator2= (AnimatorSet) AnimatorInflater.loadAnimator(Single_Hard_Activity.this,R.animator.rotate_img2);
