...
public class YouVsComputer_Activity extends AppCompatActivity {
    ...
    Map <ImageView,Integer> map = new HashMap< ImageView,Integer>();
    Integer iv11, iv12, iv13, iv14,iv15,iv16,
            iv21, iv22, iv23, iv24,iv25,iv26,
            iv31, iv32, iv33, iv34,iv35,iv36,
            iv41, iv42, iv43, iv44,iv45,iv46,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.you_vs_computer_layout);
        ...
        if (language.equals("albanian"))
        {
            ...
            tv_p2.setText("KOMPJUTERI: 0");
        }
        else
        {
            tv_p1.setText(username+": 0");
            tv_p2.setText("COMPUTER: 0");
        }
        ...
        iv_11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv11 = cardsArray[theCard]-100;
                }
                else
                {
                    iv11 = cardsArray[theCard];
                }
                map.put(iv_11,iv11);
        ...
        iv_12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv12 = cardsArray[theCard]-100;
                }
                else
                {
                    iv12 = cardsArray[theCard];
                }
                map.put(iv_12,iv12);
        ...
        iv_13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv13 = cardsArray[theCard]-100;
                }
                else
                {
                    iv13 = cardsArray[theCard];
                }
                map.put(iv_13,iv13);
        ...
        iv_14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv14 = cardsArray[theCard]-100;
                }
                else
                {
                    iv14 = cardsArray[theCard];
                }
                map.put(iv_14,iv14);
        ...
        iv_15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv15 = cardsArray[theCard]-100;
                }
                else
                {
                    iv15 = cardsArray[theCard];
                }
                map.put(iv_15,iv15);
        ...
        iv_16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv16 = cardsArray[theCard]-100;
                }
                else
                {
                    iv16 = cardsArray[theCard];
                }
                map.put(iv_16,iv16);
        ...
        iv_21.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv21 = cardsArray[theCard]-100;
                }
                else
                {
                    iv21 = cardsArray[theCard];
                }
                map.put(iv_21,iv21);
        ...
        iv_22.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv22 = cardsArray[theCard]-100;
                }
                else
                {
                    iv22 = cardsArray[theCard];
                }
                map.put(iv_22,iv22);
        ...
        iv_23.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv23 = cardsArray[theCard]-100;
                }
                else
                {
                    iv23 = cardsArray[theCard];
                }
                map.put(iv_23,iv23);
        ...
        iv_24.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv24 = cardsArray[theCard]-100;
                }
                else
                {
                    iv24 = cardsArray[theCard];
                }
                map.put(iv_24,iv24);
        ...
        iv_25.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv25 = cardsArray[theCard]-100;
                }
                else
                {
                    iv25 = cardsArray[theCard];
                }
                map.put(iv_25,iv25);
        ...
        iv_26.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv26 = cardsArray[theCard]-100;
                }
                else
                {
                    iv26 = cardsArray[theCard];
                }
                map.put(iv_26,iv26);
        ...
        iv_31.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv31 = cardsArray[theCard]-100;
                }
                else
                {
                    iv31 = cardsArray[theCard];
                }
                map.put(iv_31,iv31);
        ...
        iv_32.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv32 = cardsArray[theCard]-100;
                }
                else
                {
                    iv32 = cardsArray[theCard];
                }
                map.put(iv_32,iv32);
        ...
        iv_33.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv33 = cardsArray[theCard]-100;
                }
                else
                {
                    iv33 = cardsArray[theCard];
                }
                map.put(iv_33,iv33);
        ...
        iv_34.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv34 = cardsArray[theCard]-100;
                }
                else
                {
                    iv34 = cardsArray[theCard];
                }
                map.put(iv_34,iv34);
        ...
        iv_35.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv35 = cardsArray[theCard]-100;
                }
                else
                {
                    iv35 = cardsArray[theCard];
                }
                map.put(iv_35,iv35);
        ...
        iv_36.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv36 = cardsArray[theCard]-100;
                }
                else
                {
                    iv36 = cardsArray[theCard];
                }
                map.put(iv_36,iv36);
        ...
        iv_41.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv41 = cardsArray[theCard]-100;
                }
                else
                {
                    iv41 = cardsArray[theCard];
                }
                map.put(iv_41,iv41);
        ...
        iv_42.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv42 = cardsArray[theCard]-100;
                }
                else
                {
                    iv42 = cardsArray[theCard];
                }
                map.put(iv_42,iv42);
        ...
        iv_43.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv43 = cardsArray[theCard]-100;
                }
                else
                {
                    iv43 = cardsArray[theCard];
                }
                map.put(iv_43,iv43);
        ...
        iv_44.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv44 = cardsArray[theCard]-100;
                }
                else
                {
                    iv44 = cardsArray[theCard];
                }
                map.put(iv_44,iv44);
        ...
        iv_45.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv45 = cardsArray[theCard]-100;
                }
                else
                {
                    iv45 = cardsArray[theCard];
                }
                map.put(iv_45,iv45);
        ...
        iv_46.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv46 = cardsArray[theCard]-100;
                }
                else
                {
                    iv46 = cardsArray[theCard];
                }
                map.put(iv_46,iv46);
        ...
        iv_51.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv51 = cardsArray[theCard]-100;
                }
                else
                {
                    iv51 = cardsArray[theCard];
                }
                map.put(iv_51,iv51);
        ...
        iv_52.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv52 = cardsArray[theCard]-100;
                }
                else
                {
                    iv52 = cardsArray[theCard];
                }
                map.put(iv_52,iv52);
        ...
        iv_53.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv53 = cardsArray[theCard]-100;
                }
                else
                {
                    iv53 = cardsArray[theCard];
                }
                map.put(iv_53,iv53);
        ...
        iv_54.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv54 = cardsArray[theCard]-100;
                }
                else
                {
                    iv54 = cardsArray[theCard];
                }
                map.put(iv_54,iv54);
        ...
        iv_55.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv55 = cardsArray[theCard]-100;
                }
                else
                {
                    iv55 = cardsArray[theCard];
                }
                map.put(iv_55,iv55);
        ...
        iv_56.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (cardsArray[theCard]>200) {
                    iv56 = cardsArray[theCard]-100;
                }
                else
                {
                    iv56 = cardsArray[theCard];
                }
                map.put(iv_56,iv56);
    ...
    private void calculate() {
        ...
        if (firstCard == secondCard) {
            ...
            if (turn == 1) {
                ...
                if (language.equals("albanian"))
                {
                    tv_p2.setText("KOMPJUTERI: "+cpuPoints);
                }
                else
                {
    ...
    private void checkEnd() {
        ...
        {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(YouVsComputer_Activity.this,R.style.MyAlertDialogStyle);
            if (language.equals("albanian"))
            {
                alertDialogBuilder.setTitle("Loja perfundoj");
                alertDialogBuilder.setMessage("\n"+username+": " + playerPoints + "\nKOMPJUTERI: " + cpuPoints).setCancelable(false)
                        .setPositiveButton("LOJE E RE", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {

                                Intent intent = new Intent(getApplicationContext(), YouVsComputer_Activity.class);
                ...
                alertDialogBuilder.setMessage("\n"+username+" " + playerPoints + "\nCOMPUTER: " + cpuPoints).setCancelable(false)
    ...
    {
        final ImageView[] iv_array={iv_11,iv_12,iv_13,iv_14,iv_15,iv_16
                ,iv_21,iv_22,iv_23,iv_24,iv_25,iv_26
                ,iv_31,iv_32,iv_33,iv_34,iv_35,iv_36
                ,iv_41,iv_42,iv_43,iv_44,iv_45,iv_46
                ,iv_51,iv_52,iv_53,iv_54,iv_55,iv_56};
        Collections.shuffle(Arrays.asList(iv_array));
        ImageView img1 = null;
        ImageView img2=null;

        for (int i=0; i<iv_array.length;i++)
        {
           for (int j=0;j<iv_array.length;j++)
           {
                if (iv_array[i].getVisibility() ==View.VISIBLE && iv_array[j].getVisibility() ==View.VISIBLE &&iv_array[i]!=iv_array[j])
                {
                    img1 = iv_array[i];
                    img2 = iv_array[j];
        ...
        {
            if (map.get(img1) == map.get(img) && img1 != img)
            {
                img2 = img;
            }
        }

        if(turn==2 && img1!=null && img2!=null )
        {
            final Handler handler = new Handler();
            final ImageView finalImg = img1;
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    finalImg.performClick();
                }
            }, 800);


            final Handler handler2 = new Handler();
            final ImageView finalImg1 = img2;
            handler2.postDelayed(new Runnable() {
                @Override
                public void run() {
                    finalImg1.performClick();
                }
            }, 1600);
        }
    }
